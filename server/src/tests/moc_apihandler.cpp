...
QT_MOC_LITERAL(3, 26, 20), // "QHttpEngine::Socket*"
QT_MOC_LITERAL(4, 47, 6) // "socket"

    },
    "ApiHandler\0handleRequest\0\0"
    "QHttpEngine::Socket*\0socket"
};
...
void ApiHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->handleRequest((*reinterpret_cast< QHttpEngine::Socket*(*)>(_a[1]))); break;
        default: ;
        }
